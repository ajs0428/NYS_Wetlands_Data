...
# batch1-3 are the original pilot/priority sets; batch4-18 sweep the REMAINING
# clusters. The 18 batches are disjoint and together cover 1-250 exactly once,
# so any selection of them can be run concurrently. Keep it that way when
# editing: clusters removed from batch4-18 because they duplicated batch1-3
# (46, 82, 95, 168) must not be added back.
...
batch7=(47 48 49 52 54 55 57 58 59 61 62 63 65)
batch8=(66 68 69 70 71 72 73 74 75 76 77 78 79 80)
batch9=(81 83 85 87 88 89 91 93 94 96 97 98)
...
batch14=(164 165 166 167 169 170 171 172 173 174 175 177 178 249)
